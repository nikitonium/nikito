...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 NIKITO:
        ...
        # First: use raw transaction API to send 12400 NIKITO to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 500NIKITO for another
        ...
        # Node0's total balance should be starting balance, plus 1000NIKITO for
