...
"""Verify that starting nikitod with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nikitod with -h for help text")
        ...
        self.log.info("Start nikitod with -version for version information")
