...
from test_framework.test_framework import NikitoTestFramework
...
class LLMQChainLocksTest(NikitoTestFramework):
    def set_test_params(self):
        self.set_nikito_test_params(6, 5, fast_dip3_enforcement=True)
