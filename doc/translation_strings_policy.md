...
This document provides guidelines for internationalization of the Nikito Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `nikito_en.ts` remains unchanged.
