...
This mechanism has been integrated into Bitcore-Node-Nikito which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nikitonium/insight-api-nikito#web-socket-api](https://github.com/nikitonium/insight-api-nikito#web-socket-api)
* API: [https://github.com/nikitonium/insight-api-nikito#instantsend-transactions](https://github.com/nikitonium/insight-api-nikito#instantsend-transactions)
