...
* nikito.conf: contains configuration settings for nikitod or nikito-qt
* nikitod.pid: stores the process id of nikitod while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by nikitod or nikito-qt
