...
/** Utility functions used by the Nikito Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "nikito:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load nikito specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a nikito specific theme is activated (light/dark).*/
