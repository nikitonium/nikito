    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  nikito-qt [command-line options]                     \n";
...
All the Nikito in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 NIKI, 0.01 NIKI, 0.1 NIKI, 1 NIKI and 10 NIKI -- sort of like the paper money you use every day.</li> \
