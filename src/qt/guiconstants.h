...
/* NikitoGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* NikitoGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Nikito"
#define QAPP_ORG_DOMAIN "nikitonium.com"
#define QAPP_APP_NAME_DEFAULT "Nikito-Qt"
#define QAPP_APP_NAME_TESTNET "Nikito-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Nikito-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Nikito-Qt-regtest"
