...
//! Interface for the src/evo part of a nikito node (nikitod process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a nikito node (nikitod process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a nikito node (nikitod process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a nikito node (nikitod process).
class Node
{
public:
    virtual ~Node() {}
