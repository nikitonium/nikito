...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Nikito: 1 day
        ...
        consensus.defaultAssumeValid = uint256S("0x001350a85cdf8e6252f76f95aeaa95e759b936d15f57b04ebab5f013429b150e"); // 0
        ...
        //FindMainNetGenesisBlock(1698681125, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1698681125, 1634, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa06da458f401b198b5d8f362c16bec1fb91176095d0d460a68a4a083bfc761bd"));
        assert(genesis.hashMerkleRoot == uint256S("0xe80c73ff1c68cc2535be5926bf433c3ae01477b8381a17909081e8108e9f6d69"));

        vSeeds.emplace_back("seed.nikitonium.com");
        vSeeds.emplace_back("niki.nikitonium.com");
        ...
        // Nikito BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Nikito BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Nikito BIP44 coin type is '5'
...
//        	exit(0);
//        }
        std::vector<FounderRewardStructure> rewardStructures = {  {2761, 25},{4760, 20},{5760, 15},{INT_MAX, 10} };// founder/dev fee forever
        ...
        vSporkAddresses = {"NT3u1GbYxP3ZXbBEvNsdtKyp2iJzJP6Tmk"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Nikito: 1 day
        consensus.nPowTargetSpacing = 60; // Nikito: 1 minutes
        ...
        //FindMainNetGenesisBlock(1698681125,  0x20001fff, "test");
        genesis = CreateGenesisBlock(1698681125, 1634, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa06da458f401b198b5d8f362c16bec1fb91176095d0d460a68a4a083bfc761bd"));
        assert(genesis.hashMerkleRoot == uint256S("0xe80c73ff1c68cc2535be5926bf433c3ae01477b8381a17909081e8108e9f6d69"));
        ...
        // Testnet Nikito addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,123);
        // Testnet Nikito script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Nikito BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Nikito BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Nikito BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Nikito: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Nikito: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("nikitonium.com",  "devnet-seed.nikitonium.com"));

        // Testnet Nikito addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Nikito addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Nikito script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Nikito BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Nikito BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Nikito BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
