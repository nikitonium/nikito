...
rm -f src/config/nikito-config.h
...
rm -rf test_bitcoin.coverage/ nikito-gtest.coverage/ total.coverage/
...
clean_exe src/nikito-cli
clean_exe src/nikitod
clean_exe src/nikito-gtest
clean_exe src/nikito-tx
clean_exe src/test/test_nikito
clean_exe src/test/test_nikito_fuzzy
...
clean_dep . src/config/nikito-config.h.in
