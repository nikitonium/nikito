...
official/supported Docker Images found at https://hub.docker.com/r/nikito/nikitod/
...
**NOTE: Please update the image description at https://hub.docker.com/r/nikito/nikitod-develop/ when changing the above text**