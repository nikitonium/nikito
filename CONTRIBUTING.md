Contributing to Nikito Core
============================

The Nikito Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nikitonium/nikito/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Nikito Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Nikito
Network Protocol consensus changes.

Whether a pull request is merged into Nikito Core rests with the project merge
...
Patches that change Nikito consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nikito consensus, it must have been
...
The review process is normally fairly responsive on the Nikito Core repository, however
...
The project leader is the release manager for each Nikito Core release.
